...
void Game::scroll() {
	...
	&& MapManager::currentMap->x() + moveX / 16 < sqrt((float)MapManager::zonesSizes[MapManager::currentMap->zone()])
	&& MapManager::currentMap->y() + moveY / 16 >= 0
	&& MapManager::currentMap->y() + moveY / 16 < sqrt((float)MapManager::zonesSizes[MapManager::currentMap->zone()]))
